...
class PreTrainedTokenizerBase(SpecialTokensMixin, PushToHubMixin):
    ...
    def pad(
        ...
        if (self.model_input_names[0] not in encoded_inputs) and ("guidance" not in encoded_inputs) :
            raise ValueError(
        ...
        if (self.model_input_names[0] not in encoded_inputs):
            required_input = encoded_inputs["g"]
        else:
    ...
    def _pad(
        ...
        required_input = encoded_inputs[self.model_input_names[0]]
        required_guidance =  encoded_inputs['g']
        ...
        if needs_to_be_padded:
            ...
            if self.padding_side == "right":
                ...
                encoded_inputs['g'] = required_guidance + [self.pad_token_id] * difference
                ...
                encoded_inputs["g"] = [self.pad_token_id] * difference + required_input
            else:
