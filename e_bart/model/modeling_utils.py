...
import sys
sys.path.append('/netscratch/gillet/projects/E-BART/e_bart')
...
def _load_state_dict_into_model(model_to_load, state_dict, start_prefix):
    ...
    # export to external file but this is such a burden of time. We should rather try python operations.

    '''
        for key in state_dict["model"].keys():
            state_dict["model"][key] = state_dict["model"][key].tolist()

        import json

        file= state_dict["model"]

        with open('/Users/clementgillet/Desktop/convert.txt', 'w') as convert_file:
